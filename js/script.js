...
let p1uwx, p1uwy, p1uwz, p2uwx, p2uwy, p2uwz, p3uwx, p3uwy, p3uwz, p4uwx, p4uwy, p4uwz;
...
function init() {
    ...
    p1uxRange.addEventListener('input', function () {
    ...
    p2uxRange.addEventListener('input', function () {
    ...
    p3uxRange.addEventListener('input', function () {
    ...
    p4uxRange.addEventListener('input', function () {
    ...
    p1uyRange.addEventListener('input', function () {
    ...
    p2uyRange.addEventListener('input', function () {
    ...
    p3uyRange.addEventListener('input', function () {
    ...
    p4uyRange.addEventListener('input', function () {
    ...
    p1uzRange.addEventListener('input', function () {
    ...
    p2uzRange.addEventListener('input', function () {
    ...
    p3uzRange.addEventListener('input', function () {
    ...
    p4uzRange.addEventListener('input', function () {
    ...
    p1wxRange.addEventListener('input', function () {
    ...
    p2wxRange.addEventListener('input', function () {
    ...
    p3wxRange.addEventListener('input', function () {
    ...
    p4wxRange.addEventListener('input', function () {
    ...
    p1wyRange.addEventListener('input', function () {
    ...
    p2wyRange.addEventListener('input', function () {
    ...
    p3wyRange.addEventListener('input', function () {
    ...
    p4wyRange.addEventListener('input', function () {
    ...
    p1wzRange.addEventListener('input', function () {
    ...
    p2wzRange.addEventListener('input', function () {
    ...
    p3wzRange.addEventListener('input', function () {
    ...
    p4wzRange.addEventListener('input', function () {
    ...
    p1uwxRange.addEventListener('input', function () {
    ...
    p2uwxRange.addEventListener('input', function () {
    ...
    p3uwxRange.addEventListener('input', function () {
    ...
    p4uwxRange.addEventListener('input', function () {
    ...
    p1uwyRange.addEventListener('input', function () {
    ...
    p2uwyRange.addEventListener('input', function () {
    ...
    p3uwyRange.addEventListener('input', function () {
    ...
    p4uwyRange.addEventListener('input', function () {
    ...
    p1uwzRange.addEventListener('input', function () {
    ...
    p2uwzRange.addEventListener('input', function () {
    ...
    p3uwzRange.addEventListener('input', function () {
    ...
    p4uwzRange.addEventListener('input', function () {
...
function initializeValues() {
    ...
    p1ux = 0.2; p1uy = 0.3; p1uz = 0.6;
    p2ux = 3.0; p2uy = 4.0; p2uz = 0.0;
    p3ux = 0.0; p3uy = 3.0; p3uz = -2.7;
    p4ux = 1.0; p4uy = 1.0; p4uz = 1.0;

    p1wx = -1.0; p1wy = -1.0; p1wz = -1.0;
    p2wx = 0.0; p2wy = 1.0; p2wz = 1.0;
    p3wx = 0.5; p3wy = 0.5; p3wz = 0.7;
    p4wx = 0.0; p4wy = 0.0; p4wz = 5.0;

    p1uwx = 0.5; p1uwy = 0.0; p1uwz = 0.6;
    p2uwx = 0.5; p2uwy = 0.2; p2uwz = -0.6;
    p3uwx = 0.0; p3uwy = 0.0; p3uwz = 0.0;
    p4uwx = -0.5; p4uwy = -0.5; p4uwz = -0.6;
